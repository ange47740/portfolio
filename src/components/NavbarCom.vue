<template>
  <nav
    class="fixed z-50 flex w-full items-center justify-between bg-white/70 px-6 py-3 shadow-[0_10px_100px_rgba(0,0,0,0.1)] backdrop-blur-sm"
  >
    <!-- <div class="text-xl font-bold text-shadow-md">Wen Yi Hsu</div> -->
